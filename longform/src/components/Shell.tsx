...
/**
 * Content frame. Everything critical lives inside the AVB landscape padding
 * (marginX 56 / marginY 52) so text and callouts survive downstream cropping
 * or re-encode. Ambient imagery may still bleed to the true edge, which is why
 * this is a padded overlay rather than a clipping container.
 */
...
}> = ({ children, style, padX = SPACE.marginX, padY = SPACE.marginY, row = false, reserveBottom = 0 }) => (
  <AbsoluteFill
    style={{
      paddingLeft: padX,
      paddingRight: padX,
      paddingTop: padY,
      paddingBottom: padY + reserveBottom,
      display: "flex",
