...
/** Per-reel audio. Each reel ships its own bed, SFX timeline and VO slot. */
export const AUDIO = {
  music: (reel: 1 | 2) => staticFile(`audio/music-bed-reel${reel}.mp3`),
  sfx: (reel: 1 | 2) => staticFile(`audio/sfx-timeline-reel${reel}.mp3`),
  vo: (reel: 1 | 2) => staticFile(`vo/voiceover-reel${reel}.mp3`),
};
