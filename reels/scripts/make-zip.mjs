...
const NAME = process.argv[2] ?? "motu-ultralite828-reels-project";
const OUT = path.resolve(ROOT, "..", `${NAME}.zip`);

const INCLUDE = [
  "src", "scripts", "public",
  "package.json", "package-lock.json", "tsconfig.json", "remotion.config.ts",
  "README.md", "BRANDING_CADENCE_REEL1.md", "BRANDING_CADENCE_REEL2.md",
  "ASSET_COVERAGE_REEL1.md", "ASSET_COVERAGE_REEL2.md",
