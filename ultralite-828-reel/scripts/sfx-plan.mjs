...
// to out/audio/motu-ultralite-828-<name>-sfx-plan.json for scripts/deliver-audio.py.
...
for (const [name, tl, pins, canvas, runtime] of [["reel", REEL_TL, REEL_PINS, REEL, 90]]) {
  ...
  writeFileSync(`out/audio/motu-ultralite-828-${name}-sfx-plan.json`, JSON.stringify(plan, null, 1));
