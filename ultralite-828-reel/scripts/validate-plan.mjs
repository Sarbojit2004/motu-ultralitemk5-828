#!/usr/bin/env node
// Resolves every pin of the shot plan against the real asset index and the
...
import { REEL_PINS, buildShots, coveredSlugs } from "../src/shots.ts";
import { REEL } from "../src/theme.ts";
import { ASSETS } from "../src/assets.ts";

let bad = 0;
for (const [name, tl, pins, canvas] of [["REEL", REEL_TL, REEL_PINS, REEL]]) {
