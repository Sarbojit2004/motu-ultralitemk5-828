  ...
  if (canvas.portrait) {
    return (
      <AbsoluteFill style={{ background: GROUND.dark, fontFamily: FONT.display, overflow: "hidden" }}>
        {Room}
        <div style={{ position: "absolute", left: canvas.safe.left, width: safeW(canvas), top: canvas.safe.top + 150 }}>
          {Strip}
          <div style={{ textAlign: "center", marginTop: S(48), fontSize: S(38), letterSpacing: S(9), color: INK.onDarkDim, opacity: at(8) }}>
