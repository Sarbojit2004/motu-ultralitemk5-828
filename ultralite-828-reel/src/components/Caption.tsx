...
//
//     THE 828 HAS            lead-in   — display caps, small
...
export const splitCaption = (t: string, e?: string) => {
  ...
  // Punctuation is stripped from BOTH sides of the comparison, so "828." still
  // matches an emphasis of "828" and "2.4" still matches itself.
